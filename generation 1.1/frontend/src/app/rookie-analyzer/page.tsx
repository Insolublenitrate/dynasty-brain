...
export default function RookieAnalyzerPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 text-slate-200 p-8 flex justify-center items-center">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <div className="flex items-center gap-4">
              <h1 className="text-3xl font-black bg-gradient-to-r from-emerald-400 via-teal-500 to-indigo-500 bg-clip-text text-transparent flex items-center gap-3">
          ...
          <div className="w-full md:w-80">
            <select 
              className="bg-slate-900 border border-slate-800 text-slate-200 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 block w-full p-2.5"
        ...
        {analytics && !loadingAnalytics && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 backdrop-blur-sm shadow-xl">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-slate-400 mt-1">
                      <span className="bg-slate-800 px-2 py-0.5 rounded text-xs font-bold text-slate-300">{analytics.player_info.position}</span>
                      <span>|</span>
                ...
                <div className="flex gap-4">
                  <div className="bg-slate-800/50 p-4 rounded-lg text-center min-w-[120px] border border-slate-700/50">
                    <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">NFL Draft</div>
                    <div className="text-xl font-black text-emerald-400">{analytics.draft_info.nfl_draft_capital}</div>
                  </div>
                  <div className="bg-slate-800/50 p-4 rounded-lg text-center min-w-[120px] border border-slate-700/50">
                    <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">Dynasty ADP</div>
                    <div className="text-xl font-black text-indigo-400">{analytics.draft_info.dynasty_adp}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg hover:shadow-indigo-500/10 transition-shadow">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-lg font-black text-white flex items-center gap-2">
                    <TrendingUp size={20} className="text-indigo-400" />
                    Predicted NCAA Profile
                  </h3>
                  <span className="text-xs font-semibold px-2 py-1 bg-indigo-500/20 text-indigo-300 rounded-md border border-indigo-500/30">
                    Model: Projection
                  </span>
                </div>
                
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors">
                    <span className="text-slate-400 font-medium text-sm">Breakout Age</span>
                  ...
                  <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors">
                    <span className="text-slate-400 font-medium text-sm">College Dominator</span>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors">
                    <span className="text-slate-400 font-medium text-sm">Yds Per Route Run</span>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg hover:bg-slate-800 transition-colors">
                    <span className="text-slate-400 font-medium text-sm">Target Share</span>
                    <div className="flex items-center gap-3">
              ...
              {/* Athleticism Radar */}
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 flex flex-col shadow-lg hover:shadow-emerald-500/10 transition-shadow">
                <h3 className="text-lg font-black text-white flex items-center gap-2 mb-2">
                  <Activity size={20} className="text-emerald-400" />
                  Athletic Profile
                </h3>
                <p className="text-xs text-slate-500 mb-4">Compared to NFL positional averages</p>
              ...
              <div className="space-y-6">
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-lg hover:shadow-pink-500/10 transition-shadow">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="p-3 bg-slate-800/50 rounded-lg text-center hover:bg-slate-800 transition-colors">
                      <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">40-Yard Dash</div>
                      <div className="text-lg font-black text-white">{analytics.athleticism.forty_yard}s</div>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-lg text-center hover:bg-slate-800 transition-colors">
                      <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">Speed Score</div>
                      <div className="text-lg font-black text-white">{analytics.athleticism.speed_score}</div>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-lg text-center hover:bg-slate-800 transition-colors">
                      <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">Burst Score</div>
                      <div className="text-lg font-black text-white">{analytics.athleticism.burst_score}</div>
                    </div>
                    <div className="p-3 bg-slate-800/50 rounded-lg text-center hover:bg-slate-800 transition-colors">
                      <div className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-1">SPARQ-x</div>
                ...
                <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-xl p-6 shadow-lg shadow-indigo-500/5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="text-sm text-slate-400 font-medium">Plays style similar to</div>
            ...
            {ncaaStats.length > 0 && (
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 mt-8 shadow-lg">
