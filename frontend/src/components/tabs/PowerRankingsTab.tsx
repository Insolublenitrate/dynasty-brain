...
import { Crown, Sparkles, Shield, TrendingUp, Zap, Clock, Trophy, AlertTriangle, Layers } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-zinc-400 text-xs font-semibold tracking-wider uppercase mt-1">
            Starter Firepower + Depth + Future Draft Capital + Aging Cliff Longevity Index
          </p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {tierTeams.map((team: any) => (
                  ...
                  >
                      ...
                      <div className="flex items-center justify-between gap-3 mb-3">
                        <div className="flex items-center gap-2.5 overflow-hidden">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] font-mono text-zinc-400">Record: {team.record} • {team.fpts} Max PF</p>
                          </div>
                        </div>

                        <div className="text-right font-mono flex-shrink-0">
                          <span className="text-sm font-black text-white">{team.composite_score}</span>
                    ...
                    <div className="mt-3 pt-2 text-[10px] font-mono text-zinc-500 flex justify-between">
                      <span>Avg Starter Age: {team.avg_age}</span>
                      <span>Archetype: {team.archetype}</span>
                    </div>
                  </div>
                ))}
              </div>
