...
function DynastyRoomContent() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-5rem)] w-full max-w-full overflow-x-clip">
      ...
      <div className="-mx-2.5 sm:-mx-6 lg:-mx-8 px-2.5 sm:px-6 lg:px-8 border-b border-zinc-800/90 bg-zinc-950 sticky top-14 sm:top-16 z-30 py-1.5 sm:py-2 shadow-xl">
        <div className="max-w-[1440px] mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          
          {/* Main Arenas Switcher: 5 Primary Arenas (Desktop & Tablet) */}
      ...
      {/* ── ARENA CONTENT VIEWS ────────────────────────────────────────── */}
      <div className="flex-1 w-full max-w-[1440px] mx-auto pt-2 sm:pt-3.5 pb-[calc(7.5rem+env(safe-area-inset-bottom,0px))] md:pb-14 animate-in fade-in duration-300">
      ...
      <div className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom,0px))] md:bottom-0 left-0 right-0 w-full max-w-full overflow-hidden bg-zinc-950/95 backdrop-blur-xl border-t border-zinc-800/90 z-40 shadow-[0_-5px_20px_rgba(0,0,0,0.7)]">
