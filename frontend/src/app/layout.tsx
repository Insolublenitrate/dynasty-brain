...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark overflow-x-hidden w-full max-w-full">
      <body className={`${fontSans.variable} ${fontDisplay.variable} ${fontMono.variable} ${fontCoach.variable} font-sans bg-zinc-950 text-zinc-100 antialiased overflow-x-hidden w-full max-w-full min-w-0`}>
        <ThemeProvider>
          <LeagueProvider>
            <AppLayout>
              {children}
